...
namespace PaloWeb.Util
{
    public class WordOutputFormatter : OutputFormatter
    {
        ...
        {
            return context.Object is DocumentoViewModel;
        }
        ...
        public override async Task WriteResponseBodyAsync(OutputFormatterWriteContext context)
        {
            ...
            var viewModel = context.Object as DocumentoViewModel;
                ...
                using (WordprocessingDocument wordDoc = WordprocessingDocument.Open(mem, true))
                {
                    ...
                    foreach (var para in paras)
                    {
                        foreach (var run in para.Elements<Run>())
                        {
                            ...
                            {
                                if (text.Text.Trim().Contains("__Nome__"))
                                {
                                    text.Text = text.Text.Trim().Replace("__Nome__", viewModel.Nome);
                                }
                            }
                        }
                    }
                    ...
                    foreach (var text in wordDoc.MainDocumentPart.Document.Descendants<Text>())
                    {
                        ...
                        {
                            text.Text = text.Text.Trim().Replace("Welcome to Word", viewModel.Nome);
                        }
                    }
